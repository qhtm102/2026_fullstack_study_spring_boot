...
public class SecurityConfig {
    ...
    // Security setting 2와 함께 사용하는 UserDetailsService
//    @Bean
//    public UserDetailsService userDetailsService() { // 사용자 관리 해주는 메서드
...
//                .formLogin(AbstractHttpConfigurer::disable);
        ...
        http
                ...
                .formLogin(form -> form
                        ...
                        .loginProcessingUrl("/members/login")   // 로그인 폼 action URL : spring security가 등록한 로그인 처리 Controller에 매핑되는 경로 설정
                ...
                .logout(logout -> logout
                        .logoutUrl("/members/logout")   // spring security가 등록한 로그아웃 처리 Controller에 매핑되는 경로 설정
